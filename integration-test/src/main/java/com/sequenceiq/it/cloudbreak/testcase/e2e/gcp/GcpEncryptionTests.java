...
import static com.sequenceiq.it.cloudbreak.dto.InstanceGroupTestDto.withHostGroup;
...
public class GcpEncryptionTests extends AbstractE2ETest {
    ...
    Function<TestContext, StackTestDto> givenStackWithEncryptedDiskInHostgroup(String hostgroupName, KeyEncryptionMethod keyEncryptionMethod) {
        return testContext -> {
            List<InstanceGroupTestDto> instanceGroups = InstanceGroupTestDto.withHostGroup(testContext, HostGroupType.MASTER, HostGroupType.COMPUTE, HostGroupType.WORKER);
