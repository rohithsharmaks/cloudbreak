    ...
    public Object[][] provideInvalidAttributes() {
        return new Object[][]{
                {getBean(MockedTestContext.class), "", "badRequest", BadRequestException.class,
                        ...
                        TestCaseDescription.TestCaseDescriptionBuilder.createWithGiven("platform security groups").when("credenetial name is null").then("credential validator error")},
                ...
                {getBean(MockedTestContext.class), "andNowForSomethingCompletelyDifferent", "forbidden", ForbiddenException.class,
                        ...
                        TestCaseDescription.TestCaseDescriptionBuilder.createWithGiven("platform security groups").when("credenetial name is null").then("credential not found error")}
        };
    }
