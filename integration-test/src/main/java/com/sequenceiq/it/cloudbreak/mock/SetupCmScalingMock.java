...
public class SetupCmScalingMock {
    ...
    private static final String APPLY_HOST_TEMPLATE = ClouderaManagerMock.API_ROOT + "/clusters/:clusterName/hostTemplates/:hostTemplateName/commands/applyHostTemplate";
