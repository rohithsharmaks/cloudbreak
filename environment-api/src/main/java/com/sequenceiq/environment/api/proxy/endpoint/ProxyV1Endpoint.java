...
public interface ProxyV1Endpoint {
    ...
    @ApiOperation(value = ProxyConfigDescription.LIST_V1, produces = MediaType.APPLICATION_JSON, notes = ProxyConfigDescription.PROXY_CONFIG_NOTES,
    ...
    @Path("{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ProxyConfigDescription.GET_BY_NAME_V1, produces = MediaType.APPLICATION_JSON,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ProxyConfigDescription.CREATE_V1, produces = MediaType.APPLICATION_JSON,
    ...
    @Path("{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ProxyConfigDescription.DELETE_BY_NAME_V1, produces = MediaType.APPLICATION_JSON,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = ProxyConfigDescription.DELETE_MULTIPLE_BY_NAME_V1, produces = MediaType.APPLICATION_JSON,
