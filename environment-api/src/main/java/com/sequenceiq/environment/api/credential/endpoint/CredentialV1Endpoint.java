...
import static com.sequenceiq.environment.api.credential.doc.CredentialDescriptor.CREDENTIAL_V1_DESCRIPTION;
...
import com.sequenceiq.environment.api.credential.model.response.CredentialPrerequisitesV4Response;
...
import com.sequenceiq.environment.api.credential.model.response.InteractiveCredentialV4Response;
...
@Api(value = "/v1/credentials", description = CREDENTIAL_V1_DESCRIPTION, protocols = "http,https")
public interface CredentialV1Endpoint {

    @GET
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = CredentialOpDescription.LIST_V1, produces = MediaType.APPLICATION_JSON, notes = CredentialDescriptor.CREDENTIAL_NOTES,
    ...
    @Path("{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = CredentialOpDescription.GET_BY_NAME_V1, produces = MediaType.APPLICATION_JSON,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = CredentialOpDescription.CREATE_V1, produces = MediaType.APPLICATION_JSON, notes = CredentialDescriptor.CREDENTIAL_NOTES,
    ...
    @Path("{name}")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = CredentialOpDescription.DELETE_BY_NAME_V1, produces = MediaType.APPLICATION_JSON,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = CredentialOpDescription.DELETE_MULTIPLE_BY_NAME_V1, produces = MediaType.APPLICATION_JSON,
    ...
    @Path("")
    @Produces(MediaType.APPLICATION_JSON)
    @ApiOperation(value = CredentialOpDescription.PUT_V1, produces = MediaType.APPLICATION_JSON, notes = CredentialDescriptor.CREDENTIAL_NOTES,
    ...
    InteractiveCredentialV4Response interactiveLogin(@Valid CredentialV1Request credentialRequest);
    ...
    CredentialPrerequisitesV4Response getPrerequisitesForCloudPlatform(@PathParam("cloudPlatform") String platform,
