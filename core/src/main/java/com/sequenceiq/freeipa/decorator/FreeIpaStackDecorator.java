package com.sequenceiq.freeipa.decorator;
...
@Service
public class FreeIpaStackDecorator {

    private static final Logger LOGGER = LoggerFactory.getLogger(FreeIpaStackDecorator.class);
    ...
    @Measure(FreeIpaStackDecorator.class)
    public Stack decorate(@Nonnull Stack subject, @Nonnull FreeIpaRequest request, User user, Workspace workspace) {
    ...
    private void setEnvironment(@Nonnull Stack subject, @Nonnull FreeIpaRequest request, Workspace workspace) {
    ...
    private void prepareCredential(Stack subject, FreeIpaRequest request, Workspace workspace) {
    ...
    private void prepareInstanceGroups(Stack subject, FreeIpaRequest request, Credential credential, User user) {
    ...
    private void prepareDomainIfDefined(Stack subject, FreeIpaRequest request, User user, Workspace workspace) {
    ...
    private String getCloudPlatform(Stack stack, FreeIpaRequest request, String cloudPlatform) {
